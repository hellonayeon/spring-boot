...
public class AllInOneServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // DB 연결
        try {
            Connection connection = DriverManager.getConnection("jdbc:h2:mem:select-shop-db", "sa", "");
            // DB Query 작성
        ...
        String productJson = objectMapper.registerModule(timeModule).writeValueAsString(product);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String productsJson = objectMapper.registerModule(javaTimeModule).writeValueAsString(products);
